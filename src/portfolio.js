...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 with extensive experience of building Web and Mobile applications with TypeScript / ReactJS / NodeJS / .NET and some other cool libraries and frameworks!"
  ),
  resumeLink:
